...
# Use this file when we import the qdrant image from the docker.
# This has all the ports and config related to qdrant docker image. 
# Config like host=localhost, port=6333 (default for qdrant)
